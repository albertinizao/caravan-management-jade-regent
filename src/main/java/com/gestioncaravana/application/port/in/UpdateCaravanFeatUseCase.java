...
public interface UpdateCaravanFeatUseCase {

  CaravanFeatView execute(UUID caravanId, UUID featId, UpdateCaravanFeatCommand command);

  record UpdateCaravanFeatCommand(
